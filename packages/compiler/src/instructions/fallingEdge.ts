...
const fallingEdge: InstructionHandler = function (line, context) {
	...
	context.namespace.locals.set('__fallingEdgeDetector_currentValue' + line.lineNumber, local);
	...
	const memoryItemId = '__fallingEdgeDetector_previousValue' + line.lineNumber;
	...
	return {
		byteCode: [
			...
			operand.isInteger ? WASMInstruction.I32_LT_S : WASMInstruction.F32_LT,
			WASMInstruction.IF,
			Type.I32,
			...i32const(1),
