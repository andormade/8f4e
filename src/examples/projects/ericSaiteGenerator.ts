...
const ericSaiteGenerator: Project = {
	...
	modules: [
		...
		{
			code: ['module chord4', 'float[] notes 12', 'int length 1', 'piano notes length 36', 'init notes[0] 43.0'],
			x: -238,
			y: -2,
			isOpen: true,
		},
		{
			code: ['module chord5', 'float[] notes 12', 'int length 1', 'piano notes length 36', 'init notes[0] 38.0'],
			x: -238,
			y: 13,
			isOpen: true,
		},
		...
		},
		{
			code: [
				...
				'',
				'float* in &lcg.out',
				'float outRangeMin 48.0',
				'float outRangeMax 92.0',
				'float out',
				'',
				'debug out',
				'',
