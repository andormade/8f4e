	...
	moduleTypes: {
		...
		quantizer: {
			...
			switches: [
				...
				{ id: 'note8', onValue: 240, offValue: 0, x: 110, y: 30, width: 10, height: 10 },
				{ id: 'note9', onValue: 240, offValue: 0, x: 120, y: 30, width: 10, height: 10 },
				{ id: 'note10', onValue: 240, offValue: 0, x: 130, y: 30, width: 10, height: 10 },
				{ id: 'note11', onValue: 240, offValue: 0, x: 140, y: 30, width: 10, height: 10 },
				{ id: 'note12', onValue: 240, offValue: 0, x: 150, y: 30, width: 10, height: 10 },
			],
			name: 'Quantizer',
			sliders: [],
		},
